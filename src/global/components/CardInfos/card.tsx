...
export default function RecipeReviewCard({ data, open, handleClose, handleOpen }: any) {
    ...
    return (
        <M.Container maxWidth="xl">
            <Card onClick={() => push(`/description?id=${data[0]}`)} sx={{ display: "flex", maxWidth: "150rem", height: "45rem", margin: "0 auto" }}>
